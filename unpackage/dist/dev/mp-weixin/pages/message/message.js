    ...
    _c("view", { staticClass: "top" }, [
      _c(
        ...
        [
          _c(
            "navigator",
            { attrs: { url: "interaction", "hover-class": "navigator-hover" } },
            [
              _c("view", { staticClass: "image" }, [
                _c("image", { attrs: { src: "../../static/hd.png" } })
              ]),
              _c("view", { staticClass: "character" }, [
                _c("text", [_vm._v("互动消息")])
              ])
            ]
          )
      ...
      _c(
        ...
        [
          _c(
            "navigator",
            { attrs: { url: "others", "hover-class": "navigator-hover" } },
            [
              _c("view", { staticClass: "image" }, [
                _c("image", { attrs: { src: "../../static/qt.png" } })
              ]),
              _c("view", { staticClass: "character" }, [
                _c("text", [_vm._v("其他提醒")])
              ])
